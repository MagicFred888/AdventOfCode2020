...
namespace AdventOfCode2020.InternalTools
{
    public static partial class DataAndClassGenerator
    {
        public static bool CreateLevel(int year)
        {
            ...
            string url = $"https://adventofcode.com/{year}/day/{dayToSolve}";
            ...
            if (!Directory.Exists(newDataFolder))
            {
                ...
                if (extractPuzzle)
                {
                    ...
                    url = $"https://adventofcode.com/{year}/day/{dayToSolve}/input";
